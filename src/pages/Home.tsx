	...
	return (
		<div className="mt-0 mb-14 sm:mb-20">
			...
			<div className="text-center mx-auto mt-6 sm:mt-16 lg:mt-18 xl:mt-20 mb-10 sm:mb-20 lg:mb-24">
				...
				{/* Lightning between words (desktop only) */}
				<h1 className="flex items-center justify-center gap-4 text-[36px] xs:text-[40px] sm:text-[64px] md:text-[72px] lg:text-[77px] leading-[1.15] mb-4 sm:mb-5">
					<span>Convert</span>
