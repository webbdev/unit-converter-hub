		...
		<footer className="relative mb-0 sm:mb-7.5 bg-black sm:bg-transparent rounded-2xl sm:rounded-0">
			<Container>
				<div className="relative text-center rounded-2xl bg-black text-[#fbf5ed] sm:px-10">
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-9 sm:pt-12 xl:pt-14 pb-9 sm:pb-10 xl:pb-12">
						...
						{/* Links */}
						<div className="text-left md:px-4 sm:col-span-2 grid grid-cols-2 sm:grid-cols-2 gap-4">
